...
export const bestSellers: ProductCardData[] = [
  {
    ...
    rating: 4.9,
    reviewCount: 2841,
    badge: { label: 'Best seller', variant: 'solid' },
    imageSeed: 'prod-aurora-wand',
  },
  {
    id: 'p2',
    ...
    rating: 4.7,
    reviewCount: 1962,
    badge: { label: 'Under 40 dB', variant: 'neutral' },
    imageSeed: 'prod-pebble-bullet',
  },
  {
    id: 'p3',
    slug: 'meridian-silicone-dildo',
    name: 'Meridian Silicone Dildo, 6″',
    brand: 'Aster & Ives',
    priceCents: 7400,
    rating: 4.8,
    reviewCount: 1104,
    badge: { label: 'Platinum silicone', variant: 'accent' },
    imageSeed: 'prod-meridian-dildo',
  },
  {
    id: 'p4',
    slug: 'halo-vibrating-ring',
    name: 'Halo Vibrating Cock Ring',
    brand: 'Lumen',
    priceCents: 5900,
    compareAtPriceCents: 6900,
    rating: 4.6,
    reviewCount: 873,
    badge: { label: 'Couples', variant: 'neutral' },
    imageSeed: 'prod-halo-ring',
  },
  {
    id: 'p5',
    slug: 'onyx-weighted-plug',
    name: 'Onyx Weighted Steel Plug',
    brand: 'Aster & Ives',
    priceCents: 8900,
    rating: 4.9,
    reviewCount: 641,
    badge: { label: '316L steel', variant: 'accent' },
    imageSeed: 'prod-onyx-plug',
  },
  {
    id: 'p6',
    slug: 'tide-water-based-lubricant',
    name: 'Tide Water-Based Lubricant, 150ml',
    brand: 'Good Time Studio',
    priceCents: 1800,
    rating: 4.8,
    reviewCount: 3417,
    badge: { label: 'Toy safe', variant: 'success' },
    imageSeed: 'prod-tide-lube',
  },
  {
    id: 'p7',
    slug: 'vesper-remote-egg',
    name: 'Vesper App-Controlled Egg',
    brand: 'Lumen',
    priceCents: 11_900,
    rating: 4.5,
    reviewCount: 728,
    badge: { label: 'App controlled', variant: 'accent' },
    imageSeed: 'prod-vesper-egg',
  },
  {
    id: 'p8',
    slug: 'ember-dual-vibrator',
    ...
    rating: 4.7,
    reviewCount: 1583,
    badge: { label: 'Save 20%', variant: 'danger' },
    imageSeed: 'prod-ember-dual',
  },
];
...
export const trendingProducts: ProductCardData[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 356,
    badge: { label: 'Save 16%', variant: 'danger' },
    imageSeed: 'trend-cuffs',
  },
  {
    id: 't3',
    slug: 'drift-stroker',
  ...
  },
  {
    ...
    reviewCount: 934,
    badge: { label: 'App controlled', variant: 'accent' },
    imageSeed: 'trend-tandem',
  },
  {
    id: 't5',
    slug: 'graduated-plug-trio',
    name: 'Graduated Silicone Plug Trio',
    brand: 'Aster & Ives',
    priceCents: 4900,
    rating: 4.7,
    reviewCount: 815,
    badge: { label: 'Beginner friendly', variant: 'neutral' },
    imageSeed: 'trend-plug-trio',
  },
  {
    id: 't6',
    slug: 'reset-toy-cleaner',
    name: 'Reset Toy Cleaner, 200ml',
    brand: 'Good Time Studio',
    priceCents: 1400,
    rating: 4.9,
    reviewCount: 2204,
    badge: { label: 'Fragrance free', variant: 'success' },
    imageSeed: 'trend-cleaner',
  },
  {
    id: 't7',
    slug: 'blackout-blindfold',
    ...
    reviewCount: 447,
    badge: null,
    imageSeed: 'trend-blindfold',
  },
  {
    id: 't8',
    slug: 'harbour-storage-case',
    name: 'Harbour Lockable Storage Case',
    brand: 'Good Time Studio',
    priceCents: 4400,
    rating: 4.8,
    reviewCount: 302,
    badge: { label: 'Lockable', variant: 'neutral' },
    imageSeed: 'trend-storage',
  },
];
